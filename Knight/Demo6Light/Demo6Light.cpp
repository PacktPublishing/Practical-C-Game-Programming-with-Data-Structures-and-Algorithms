...
void Demo6Light::Start()
{
	...
	animEnemyComponent->Load3DModel((Config.ResourcesBasePath + "models/obj/bridge.obj").c_str());
	Image image = LoadImage((Config.ResourcesBasePath + "models/obj/bridge_diffuse.png").c_str());
